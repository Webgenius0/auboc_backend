                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="theme-form" action="{{route('cms.business-home-page.section-four.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <a href="{{ route('cms.business-home-page.section-four') }}" class="btn btn-warning">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
