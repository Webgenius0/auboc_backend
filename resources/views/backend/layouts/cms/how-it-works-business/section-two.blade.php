                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="theme-form" action="{{route('cms.how-it-works-business.section-two.update')}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <a href="{{ route('cms.how-it-works-business.section-two') }}" class="btn btn-warning">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
