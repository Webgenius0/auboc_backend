                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="theme-form" action="{{ route('cms.about-page.section.update') }}" method="post"
                                    ...
                                    <div class="card-footer text-end">
                                        ...
                                        <a href="{{ route('cms.about-page.section') }}" class="btn btn-warning">Cancel</a>
                                    </div>
                                </form>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form class="theme-form" action="{{ route('cms.about-page.section.item-one.update') }}"
