...
<div class="page-header">
    <div class="header-wrapper row m-0">
        <div class="header-logo-wrapper col-auto p-0">
            ...
            <div class="logo-header-main"><a href="index.html"><img class="img-fluid for-light img-100" src="{{asset('backend/images/logo/logo2.png')}}" alt=""><img class="img-fluid for-dark" src="{{asset('backend/images/logo/logo.png')}}" alt=""></a></div>
        </div>
...
{{--                                <div class="message-img bg-light-primary"><img src="{{asset('backend/images/user/3.jpg')}}" alt=""></div>--}}
{{--                                <div class="flex-grow-1">--}}
...
{{--                        <li>--}}
{{--                            <div class="d-flex align-items-start">--}}
{{--                                <div class="message-img bg-light-primary"><img src="{{asset('backend/images/user/6.jpg')}}" alt=""></div>--}}
{{--                                <div class="flex-grow-1">--}}
...
{{--                        <li>--}}
{{--                            <div class="d-flex align-items-start">--}}
{{--                                <div class="message-img bg-light-primary"><img src="{{asset('backend/images/user/10.jpg')}}" alt=""></div>--}}
{{--                                <div class="flex-grow-1">--}}
                ...
                <li class="profile-nav onhover-dropdown">
                    <div class="account-user">
                        @isset($users)
                            ...
                            @else
                                <img src="{{asset('backend/images/avtar/3.jpg')}}" class="img-50 img-fluid m-r-20 rounded-circle" alt="">
                            @endif
                        @else
                            <img src="{{asset('backend/images/avtar/3.jpg')}}" class="img-50 img-fluid m-r-20 rounded-circle" alt="">
                        @endisset
                    ...
                    <ul class="profile-dropdown onhover-show-div">
                        ...
                        <li><a href="{{route('settings.profile')}}"><i data-feather="user"></i><span>Account</span></a></li>
{{--                        <li><a href="email_inbox.html"><i data-feather="mail"></i><span>Inbox</span></a></li>--}}
                        <li><a href="{{route('settings.system.index')}}"><i data-feather="settings"></i><span>Settings</span></a></li>
                        <li>
