        ...
        <nav class="sidebar-main">
            ...
            <div id="sidebar-menu">
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><i class="fa fa-thumb-tack"></i><a class="sidebar-link sidebar-title {{ Request::routeIs('settings.*') ? 'active open' : '' }}" href="javascript:void(0)"><i data-feather="settings"></i><span>Settings</span></a>
                        <ul class="sidebar-submenu">
                            <li><a class="{{ Request::routeIs('settings.profile') ? 'active' : '' }}" href="{{route('settings.profile')}}">Profile Settings</a></li>
                            <li><a class="{{ Request::routeIs('settings.system.index') ? 'active' : ' ' }}" href="{{route('settings.system.index')}}">System Settings</a></li>
                            <li><a class="{{ Request::routeIs('settings.mail') ? 'active' : ' ' }}" href="{{route('settings.mail')}}">Mail Settings</a></li>
                            <li><a class="{{ Request::routeIs('settings.stripe.index') ? 'active' : ' ' }}" href="{{route('settings.stripe.index')}}">Stripe Settings</a></li>
                            <li><a class="{{ Request::routeIs('settings.dynamic-page.index') || Request::routeIs('settings.dynamic-page.create') || Request::routeIs('settings.dynamic-page.edit') ? 'active' : ' ' }}" href="{{route('settings.dynamic-page.index')}}">Dynamic Page Settings</a></li>
                            <li><a class="{{ Request::routeIs('settings.custom-script.*') ? 'active' : ' ' }}" href="{{route('settings.custom-script.index')}}">Custom Script Settings</a></li>
                        </ul>
                    </li>
