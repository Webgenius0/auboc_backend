...
@section('title','Zally-blog-zelly-updates-details')
        ...
        <div class="container">
            <div class="event-details-page-container">
                <div class="event-details-page-contents-container">
                    <!-- tittle -->
                    <div class="event-details-page-title text-dark">How AI is shaping Cybersecurity & Business Transformation</div>
                    <!-- -events image -->
                    ...
                    <div class="sl-blog-tab-btn-wrapper">
                        <div class="bi-tab-btns-container">
                            <button class="bi-common-tab-btn text-dark active">overview</button>
                            <button class="bi-common-tab-btn text-dark">sponsors</button>
                            <button class="bi-common-tab-btn text-dark">speakers and panel</button>
                        </div>
                    </div>
                    <!-- counters  -->
                    ...
                    <div class="event-page-tab-content-container">
                        ...
                        <div class="event-common-tab  active">
                            <a href="#">https://www.flipoff.co.uk/flip-1-0</a> The technology industry is growing year-on-year. Understanding
                            the impact of AI and new developments on the industry is key for businesses to stay competitive and increase
                            efficiency. Patrick Smith, our founder and CEO, joined a panel at the "Digital Leadership Report" event hosted by
                            Harvey Nash. He was joined by Nick Woods -CIO of MAG (Airports Group), and Christopher Williamson - Technology
                            Director of N Brown Group. Together, they discussed issues in cybersecurity, artificial intelligence, and business
                            transformation.
