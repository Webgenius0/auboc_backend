...
@section('title','Zally-event-details-session')
    ...
    <section class="smooth--section">
        <div class="container event-details-page-container">
            <div class="event-details-page-contents-container">
                <!-- tittle -->
                <div class="event-details-page-title text-dark">gen z: the future of work</div>
                <!-- -events image -->
                <div class="event-page-image-section">
                    <img src="{{asset('frontend/images/event-details-2.png')}}" alt="" srcset="">
