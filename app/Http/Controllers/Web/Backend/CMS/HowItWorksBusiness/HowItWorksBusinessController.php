...
namespace App\Http\Controllers\Web\Backend\CMS\HowItWorksBusiness;
...
class HowItWorksBusinessController extends Controller
{
    //Section One
    ...
    public function sectionOne()
    {
        ...
        $data = CMS::where('page', Page::HowItWorksBusinessPage)->where('section', Section::SectionOne)->first();
        return view('backend.layouts.cms.how-it-works-business.section-one', compact('data'));
    }
    ...
    public function storeSectionOne(Request $request)
    {
        ...
        $data = CMS::updateOrCreate(
            [
                'page' => Page::HowItWorksBusinessPage,
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::HowItWorksBusinessPage)->where('section', Section::SectionTwo)->first();
        return view('backend.layouts.cms.how-it-works-business.section-two', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::HowItWorksBusinessPage)->where('section', Section::SectionThree)->first();
        return view('backend.layouts.cms.how-it-works-business.section-three', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::HowItWorksBusinessPage)->where('section', Section::SectionFour)->first();
        return view('backend.layouts.cms.how-it-works-business.section-four', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::HowItWorksBusinessPage)->where('section', Section::SectionFive)->first();
        return view('backend.layouts.cms.how-it-works-business.section-five', compact('data'));
    }
