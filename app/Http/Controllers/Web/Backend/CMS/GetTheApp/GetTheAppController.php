...
namespace App\Http\Controllers\Web\Backend\CMS\GetTheApp;
...
class GetTheAppController extends Controller
{
    //Section One
    ...
    public function sectionOne()
    {
        ...
        $data = CMS::where('page', Page::GetTheAppPage)->where('section', Section::SectionOne)->first();
        return view('backend.layouts.cms.get-the-app.section-one', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::GetTheAppPage)->where('section', Section::SectionTwo)->first();
        return view('backend.layouts.cms.get-the-app.section-two', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::GetTheAppPage)->where('section', Section::SectionThree)->first();
        return view('backend.layouts.cms.get-the-app.section-three', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::GetTheAppPage)->where('section', Section::SectionFour)->first();
        return view('backend.layouts.cms.get-the-app.section-four', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::GetTheAppPage)->where('section', Section::SectionFive)->first();
        return view('backend.layouts.cms.get-the-app.section-five', compact('data'));
    }
