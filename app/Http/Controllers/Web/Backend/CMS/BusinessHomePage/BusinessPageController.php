...
namespace App\Http\Controllers\Web\Backend\CMS\BusinessHomePage;
...
class BusinessPageController extends Controller
{
    ...
    public function sectionOne()
    {
        ...
        $data = CMS::where('page', Page::BusinessPage)->where('section', Section::SectionOne)->first();
        return view('backend.layouts.cms.business-home-page.section-one', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::BusinessPage)->where('section', Section::SectionTwo)->first();
        return view('backend.layouts.cms.business-home-page.section-two', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::BusinessPage)->where('section', Section::SectionThree)->first();
        return view('backend.layouts.cms.business-home-page.section-three', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::BusinessPage)->where('section', Section::SectionFour)->first();
        return view('backend.layouts.cms.business-home-page.section-four', compact('data'));
    }
    ...
    {
        // Retrieve the CMS data for the banner section of the homepage
        $data = CMS::where('page', Page::BusinessPage)->where('section', Section::SectionFive)->first();
        return view('backend.layouts.cms.business-home-page.section-five', compact('data'));
    }
